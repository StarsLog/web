(function (global, factory) {
    ...
    var InteractionManager = function InteractionManager(renderer, camera, domElement) {
      ...
      this.dispose = function () {
        ...
        _this.domElement.removeEventListener('dblclick', _this.onMouseDblClick);
      ...
      this.onMouseDblClick = function (mouseEvent) {
        _this.update();
  
        var event = new InteractiveEvent('dblclick', mouseEvent);
      ...
      domElement.addEventListener('dblclick', this.onMouseDblClick);
